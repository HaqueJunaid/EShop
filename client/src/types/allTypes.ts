...
export interface cartStoreInterface {
    ...
    removeCartItem: (productId: string, customizations?: Record<string, string>) => void;
    updateCartItemQuantity: (productId: string, quantity: number, customizations?: Record<string, string>) => void;
    clearCart: () => void;
    getCartTotal: () => number;
