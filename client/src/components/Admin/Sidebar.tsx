...
const Sidebar = ({isOpen, setIsOpen}: {isOpen: boolean, setIsOpen: () => void}) => {
    ...
    return (
        <div className={`fixed lg:sticky ${!isOpen ? "hidden" : "block"} lg:block z-50 top-0 left-0 min-w-68 h-screen bg-stone-50 px-2 py-3 shadow-lg border-r-2 border-stone-200`}>
            ...
            <div className='flex items-center gap-1'>
                <Link to="/">
                    <img className='size-15' src="https://srishbish.com/cdn/shop/files/SRISHBISH_2_244x.png?v=1648184973" alt="Logo" />
                </Link>
